...
export function MovieProvider({ children }) {
  ...
  const filteredGenre = async () => {
    const data = await fetch(
      `https://api.themoviedb.org/3/discover/movie?with_genres=${activegenre}&api_key=4e44d9029b1270a757cddc766a1bcb63&with_origin_country=IN&page=${page}`
    );
  ...
  const fetchSearch = async (query) => {
    const data = await fetch(
      `https://api.themoviedb.org/3/search/movie?api_key=4e44d9029b1270a757cddc766a1bcb63&with_origin_country=IN&language=en-US&query=${query}&page=1&include_adult=false`
    );
  ...
  const fetchGenre = async () => {
    const data = await fetch(
      `https://api.themoviedb.org/3/genre/movie/list?api_key=4e44d9029b1270a757cddc766a1bcb63&with_origin_country=IN&language=en-US`
    );
  ...
  const fetchTrending = async () => {
    const data = await fetch(
      `https://api.themoviedb.org/3/trending/movie/day?api_key=4e44d9029b1270a757cddc766a1bcb63&with_origin_country=IN&page=${page}`
    );
  ...
  const fetchUpcoming = async () => {
    const data = await fetch(
      `https://api.themoviedb.org/3/movie/upcoming?api_key=4e44d9029b1270a757cddc766a1bcb63&with_origin_country=IN&language=en-US&page=${page}`
    );
